...
import 'package:ditonton/features/tv_series/domain/usecases/get_now_playing_tv_series/get_tv_series_list_params.dart';
...
class GetTvSeriesList
  ...
  Future<Either<Failure, List<TvSeries>>> call(
    ...
    return switch (params.category) {
      ...
      TvSeriesListCategories.upcoming => await repository.getPopularTvSeries(),
    };
  }
}
